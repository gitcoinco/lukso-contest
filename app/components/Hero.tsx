    ...
    <div className="relative min-h-[910px] md:h-screen flex items-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center text-white">
        ...
        <div className="flex flex-col md:gap-2 md:mb-8 -mb-2">
          <div className="text-center text-white text-[30px] md:text-[40px] font-semibold leading-[54px]">
            LUKSO Grants Wave 2
          </div>
          <div className="text-center text-white text-[70px] md:text-[90px] font-bold font-['Vipnagorgialla'] leading-[99px]">
            HACK THE GRID
          </div>
          <div className="text-center text-white text-[30px] lg:text-[40px] font-semibold leading-[54px]">
