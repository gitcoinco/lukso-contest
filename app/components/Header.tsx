...
export default function Header() {
  ...
  return (
    <header className={`p-10 fixed top-0 left-0 right-0 z-50 ${theme === 'dark' ? 'bg-[#0a090d]' : 'bg-brand'}`}>
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden md:block">
              <ul className="flex gap-6">
                ...
                <li>
                  <Link href="/leaderboard" className="text-white hover:opacity-90 transition-opacity">Leaderboard</Link>
                </li>
                <li>
                  <Link href="https://t.me/+OqS-Y3s-dvZjZWFh" className="text-white hover:opacity-90 transition-opacity" target='_blank'>Telegram</Link>
                </li>
              </ul>
            </nav>
