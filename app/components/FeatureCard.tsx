...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div className="border-none w-[405.34px] h-[432px] p-[26px] bg-[#121212]/90 rounded-3xl shadow-lg border flex-col justify-start items-start gap-4 inline-flex overflow-hidden">
      <div className="text-center text-white/70 text-base font-medium font-['Inter'] leading-7">
        {title}
      </div>
      ...
      <div className="flex-col justify-start items-center flex">
        <div className="text-center text-white text-xl font-bold font-['Inter'] leading-7">
          {heading}
        </div>
      </div>
      <div className="self-stretch text-white/70 text-base font-normal font-['Inter'] leading-normal">
        {description}
      </div>
    </div>
  );
